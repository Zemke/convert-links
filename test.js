...
it('containing nothing more than a link', () => {
  expect(convertLinks("www.cwtsite.com"))
    .toEqual('<a href="http://www.cwtsite.com" target="_blank">www.cwtsite.com</a>')
});

it('with a link surrounded by strings.', () => {
  expect(convertLinks("The greatest page in the world is www.cwtsite.com I swear!"))
...
it('containing http or www or https.', () => {
  ...
  expect(convertLinks("A page called www.cwtsite.com is a nice page."))
